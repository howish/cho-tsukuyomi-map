...
window.EVENT_CONFIG = {
  ...
  // Per-area map: the standard 専區 area filter (南/東/西展示棟) doubles as
  // the map selector — picking one swaps to that building's floor map
  // (area-map.js + maps.js, generated by build_c108_map.py). map_image is
  // the initial 会場全体図. 公式マップは準備会著作物のため非掲載。
  map_image: "map-overview.svg",
  map_caption: "展示棟を選ぶとそのフロア図に切替 (カード連動: 連動/全件) ／ マップ上のサークルをタップで詳細。非公式・当落報告より作図、縮尺は不正確",
