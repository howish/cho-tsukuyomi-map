window.BOOTHS = [
  ...
  },
  {
    ...
    "body": "## 📝 ヤオヨロー！ 出展ハイライト\n- **校正中** (5/29 時点) — 「校正する前にやっぱり浴びておかないとね！」\n- 頒布物詳細は当日告知待ち\n\n出典: [校正進捗](https://x.com/YukkuriShimiya/status/2060505960440082558)",
    "cps": [],
    "tags": {},
    "min_price": null,
    "cover_urls": [
  ...
  },
  {
    ...
    "body": "## 📝 ヤオヨロー！ 出展ハイライト\n- **コスプレ写真集** 頒布予定 (絶賛編集中)\n\n## ⚠️ 注意事項\n- **配置 変更** (5/30 告知) — スペース名は **ヤオ-36** のまま、 場所が **コスプレゾーン側** に移動\n\n出典: [本サークル 告知](https://x.com/nyanruikai/status/2056678582215479352) / [配置変更告知](https://x.com/nyanruikai/status/2060615518546223367)",
    "cps": [],
    "tags": {},
    "min_price": null,
    "cover_urls": [
