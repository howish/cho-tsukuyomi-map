...
window.I18N_STRINGS = {
  ja: {
    ...
    edit_images_banner: '🖼 画像 (cover_urls) 編集 — 左=source / 右=display、1 行 1 件で行対応',
    edit_images_placeholder: '画像 URL を 1 行 1 件で入力 (空行は無視)',
    edit_source_label: 'source URL (どこから持ってきたか — FB share / Plurk /p/CODE / X status URL 等)',
    edit_source_placeholder: 'https://www.facebook.com/share/p/...\nhttps://www.plurk.com/p/...',
    edit_display_label: 'display URL — 空欄 = auto (pipeline が生成)、入力すれば custom 固定',
    edit_display_placeholder: '通常は空欄で OK。R2 などの直リンクを指定したい時のみ入力',
    edit_save_btn: '💾 保存',
  ...
  'zh-tw': {
    ...
    edit_images_banner: '🖼 圖片 (cover_urls) 編輯 — 左=source / 右=display，一行一個、左右行對齊',
    edit_images_placeholder: '一行一個圖片 URL (空行會被忽略)',
    edit_source_label: 'source URL (來源連結 — FB share / Plurk /p/CODE / X status URL 等)',
    edit_source_placeholder: 'https://www.facebook.com/share/p/...\nhttps://www.plurk.com/p/...',
    edit_display_label: 'display URL — 留空 = auto (pipeline 自動產生)，填入 = 鎖定為自訂',
