...
window.I18N_STRINGS = {
  ja: {
    ...
    edit_image_move_left_tooltip: '前へ移動 (◀)',
    edit_image_move_right_tooltip: '次へ移動 (▶)',
    edit_carousel_hint: '◀ ▶ で並べ替え · × で削除 · + で追加 · スワイプでプレビュー',
    edit_images_advanced_summary: '🔧 URL 詳細 / lock 設定 (advanced)',
    edit_images_empty: 'まだ画像なし。 下の + ボタンで追加してください',
    edit_images_empty_thumb: '(URL 未入力)',
    edit_save_btn: '💾 保存',
    ...
    modal_source_pixiv: 'Pixiv',
    modal_source_bsky: 'Bluesky',
    modal_source_blog: 'Blog',
    modal_source_wix: 'Portfolio',
    modal_source_gamer: '巴哈姆特',
    modal_source_booth_pm: 'BOOTH',
    modal_source_marshmallow: 'マシュマロ',
    modal_source_patreon: 'Patreon',
  ...
  'zh-tw': {
    ...
    edit_image_add: '+ 新增圖片',
    edit_image_move_left_tooltip: '前移 (◀)',
    edit_image_move_right_tooltip: '後移 (▶)',
    edit_carousel_hint: '◀ ▶ 排序 · × 刪除 · + 新增 · 滑動切換預覽',
    edit_images_advanced_summary: '🔧 URL 詳細 / lock 設定 (advanced)',
    edit_images_empty: '尚無圖片。 點下方 + 新增',
    edit_images_empty_thumb: '(尚未填 URL)',
    ...
    modal_source_pixiv: 'Pixiv',
    modal_source_bsky: 'Bluesky',
    modal_source_blog: '部落格',
    modal_source_wix: '個人網站',
    modal_source_gamer: '巴哈姆特',
    modal_source_booth_pm: 'BOOTH',
    modal_source_marshmallow: 'マシュマロ',
    modal_source_patreon: 'Patreon',
