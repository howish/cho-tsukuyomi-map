window.BOOTHS = [
  ...
  },
  {
    ...
    "followers": 87,
    "tier": "B",
    "body": "- **サークル名「群青プラネタリウム」 確定** [5/23 update]\n- **新刊**：『**超らくがき本**』 B5/フルカラー/12P/¥500\n  - 表紙：金髪ロング キャップ被ったキャラ (オリジナル?彩葉?要確認)\n  - + 作れたらペーパー付属するかも\n- **お釣り NG** (現金ジャスト推奨)、一般参加者向け案内マナー要請\n- 配置疑惑解消 (旧「お品書き画像 A-12 表記」 ＝ 実は A-13 正解)\n- [2026-05-23 howish 発見・update：サークル名 + 新刊詳細判明、Tier C → Tier B]"
  },
  {
    "booth_id": "A-14",
    "circle_name": "ATOLEG",
  ...
  },
  {
    ...
    "followers": 552,
    "tier": "C",
    "body": "- **コピ本予定** (今描いてる、表紙 sketch のみ公開 — 白髪キャラ歓喜表情)\n- 詳細価格 / ページ未確定、お品書きなし\n- 急遽参加、コピ本 1 種のみで身軽\n- [2026-05-23 howish 発見・update：コピ本参戦判明、本文制作中、Tier C 維持]"
  },
  {
    "booth_id": "A-18",
    "circle_name": "更科るな",
  ...
  },
  {
    ...
    "followers": 1686,
    "tier": "A",
    "body": "- **サークル名「何もかもぶれぶれ」 確定** [5/23 update]\n- **新刊その 1**：『**私の未来ってどうなるの〜!?**』\n  - **A5/22P/¥500/漫画**\n  - 「ある日、彩葉の元にかぐや、ヤチヨ、芦花が **未来からやってくる** → どうやら **三人は未来の彩葉と付き合っているらしい**…というわちゃわちゃ本」\n  - = **いろハーレム** 漫画 ([[愛される側の盲点-曖昧な十年]] craft の \"全方向愛されてる いろは\" 構造を直球で本にした例)\n  - 表紙：彩葉中央 + 周囲かぐや・ヤチヨ・芦花 (黒髪青服)\n- **新刊その 2**：『**君の声を隣に感じて**』 (コピー本)\n  - **A5/8P/¥100/小説**\n  - 「**大学生になった彩葉がヤチヨと寝落ち通話をする話**」\n  - = いろヤチ 寝落ち通話 (continuation craft、義體前の dialogue 時代)\n  - 表紙：彩葉 ipad ベッドで横向き\n- [2026-05-23 howish 発見・update：サークル名 + 2 種詳細判明、Tier C → Tier A 級]"
  },
  {
    "booth_id": "A-24",
    "circle_name": "月の南極",
  ...
  },
  {
    ...
    "followers": 24546,
    "tier": "B",
    "body": "- **新刊**：『Color your life』 らくがきイラスト本\n- **¥500 (ワンコイン)** [5/23 update]、「対よろ」 = 対戦よろしく ＝ 高 buzz 想定\n- 詳細お品書き画像なし、本人 tweet は価格のみ提示\n- 聖地巡礼兼ねて立川来訪\n- [2026-05-23 howish 発見・update：¥500 価格確定]"
  },
  {
    "booth_id": "B-09",
    "circle_name": "羽降りの庭",
    ...
    "followers": 488,
    "tier": "S+",
    "body": "- **新刊**：『光のトリコロール』(Tricolor of Light) よろず小説合同\n  - **A5 / 108P / ¥1,000 / ヤチいろかぐ / 🔞 R-18 含む (年齢確認要)**\n  - **8 作家参加**：赤羽ひふみ／茶菓子／虎／ぬえ／はぬわ／マーライオン／右本渺／ユウソン\n  - 表紙：れぇ (三人キス寸前)\n- **委託本 ALL ¥500/全年齢** [2026-05-23 howish 発見・update]：\n  - 『**果てしない季節を君と**』 いろかぐ小説 / **マーライオンさん** / A5/48P\n  - 『**(I'm not) said adore**』 **ろかいろ (芦花×彩葉) 小説** / **右本渺さん** / B6/52P ← [[愛される側の盲点-曖昧な十年]] craft 直結、B-05 こうらぼし『色は匂えど』 と並ぶ 芦花×彩葉 craft 第二源泉、コスパ良 (¥500 で 52P 小説)\n- → **B-09 ブース 1 箇所で 3 種 (新刊 R-18 合同 + 委託 2 種)** が一気に入手可能、巡回効率優秀"
  },
  {
    "booth_id": "B-10",
    "circle_name": "(空飛ぶお布団)",
  ...
  },
  {
    ...
    "followers": 6924,
    "tier": "S+",
    "body": "- **新刊**：『**いろはにほかろ**』 (いろは + ほか + ろか の punning title — いろはにほへと の alphabet poem + 多 CP まとめ示唆)\n  - **文庫本サイズ / 134P / ¥1,000 (予定) / 全年齢**\n  - **いろ × ○○ CP まとめ本** = **いろかぐ / いろろか / いろヤチ ss 短編集**\n  - 表紙：いろは (黒髪・サスペンダースカート) と狐耳キャラ (彩葉 or 別キャラ) の hug 構図 + 小キャラ icon (かぐや・真実?)\n  - 「書き下ろしショートストーリー (いろろか) のサンプルがツリーに掲載」\n- [2026-05-23 howish 発見・update：旧記載の book title 『Reply, Your Future Otogibanashi』 は誤りで、実際は『いろはにほかろ』 — 旧 subagent recon の誤マッピング修正]"
  },
  {
    "booth_id": "B-12",
  ...
  },
  {
    ...
    "followers": 93166,
    "tier": "B",
    "body": "- **参戦確認！** [5/23 update]、handle が \"ホロクル Q08\" だが超ツクヨミ祭 C-05 にも出展\n- **新刊**：『**INU DOG**』 オタ公落書き本 — **🔞 R-18 成人向け**、要 ID\n  - 表紙：オタ公 (狼/狐耳キャラ、メイド服風、白髪) 露出度高め R-18 cover\n  - 「全然顔が安定しないんですがまだ練度が足りませんでした…難しい」 (本人 comment、まだ作画修行中)\n- **体調不良中**、最悪 売り子さん任せの可能性\n- 93k follower 大手、craft 系よりは R-18 専門\n- [2026-05-23 howish 発見・update：参戦確認 + 新刊判明、Tier C 要確認 → Tier B]"
  },
  {
    "booth_id": "C-06",
    "circle_name": "ハルハン",
  ...
  },
  {
    ...
    "followers": 13734,
    "tier": "A",
    "body": "- **サークル名「夢の中でもキミに会いたい」 確定** [5/23 update]\n- **新刊**：『**精一杯のありがとうを**』 B5/14P/モノクロ/¥500\n  - 表紙：かぐや (兎耳、星空背景、感涙表情) — Cosmic Princess Kaguya Unofficial Fanbook、2026.05.24 日付\n- **フルカラー色紙**：各 **¥2,500** — **各回 3 枚ずつ同構図 用意** (3 部 = 計 9 枚)、ヤチヨくんとも 他のイラスト製作中\n- **フルカラーポストカードサイズイラスト**：¥2,000\n- 13.7k follower、craft 系イラスト中心\n- [2026-05-23 howish 発見・update：サークル名 + 新刊詳細 + 色紙・ポストカード判明、Tier C → Tier B/A 級]"
  },
  {
    "booth_id": "C-10",
    "circle_name": "39dmp",
